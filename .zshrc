...
# Move the custom dir out of OH-MY-ZSH to make it possible to add to the
# dotfiles repo
...
plugins=(git nvm rbenv sdk z)

# The oh-my-zsh sdkman plugin does not instaniate SDKMAN. We must manually load
# it before the zsh plugin is loaded for the plugin to have any effect.
source "$HOME/.sdkman/bin/sdkman-init.sh"

NVM_HOMEBREW='/opt/homebrew/opt/nvm'

# Autoload .nvmrc files (slow)
